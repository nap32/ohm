...
mod tests {
    ...
    lazy_static! {
        static ref TRAFFIC_ONE: Traffic = Traffic {
            ...
            response_headers: HashMap::from([
                ...
                (
                    "expires".to_string(),
                    "Thu, 04 Jan 2024 01:28:10 GMT".to_string()
                ),
                ...
                (
                    "date".to_string(),
                    "Wed, 04 Jan 2023 01:28:10 GMT".to_string()
                ),
                (
                    "last-modified".to_string(),
                    "Tue, 03 Jan 2023 09:12:52 GMT".to_string()
                ),
                (
                ...
                (
                    ...
                    "same-origin; report-to=gws-team".to_string()
                ),
            ...
            response_body: [
                31, 139, 8, 0, 0, 0, 0, 0, 0, 0, 157, 83, 209, 110, 218, 48, 20, 125, 231, 43, 168,
                31, 144, 45, 89, 105, 171, 178, 178, 21, 69, 19, 109, 105, 65, 237, 186, 54, 165,
                210, 222, 34, 39, 118, 136, 219, 16, 179, 216, 1, 162, 192, 191, 207, 54, 161, 13,
                108, 108, 104, 79, 137, 175, 125, 207, 185, 62, 231, 88, 101, 69, 217, 144, 62,
                129, 128, 127, 121, 126, 184, 140, 0, 234, 54, 102, 36, 107, 74, 191, 127, 27, 185,
                210, 31, 64, 64, 127, 12, 123, 231, 186, 190, 46, 223, 232, 114, 148, 167, 161,
                226, 34, 133, 4, 149, 210, 23, 78, 72, 146, 4, 170, 152, 75, 76, 156, 59, 130, 186,
                230, 215, 201, 132, 80, 253, 132, 77, 88, 170, 92, 91, 24, 51, 229, 233, 26, 68,
                14, 75, 96, 117, 200, 123, 210, 28, 119, 235, 94, 240, 237, 49, 255, 116, 22, 130,
                106, 159, 71, 144, 232, 77, 239, 39, 220, 133, 195, 32, 33, 1, 75, 18, 70, 131, 2,
                32, 84, 154, 193, 2, 151, 138, 48, 55, 187, 134, 167, 58, 120, 89, 12, 169, 158,
                177, 27, 180, 90, 48, 112, 36, 83, 61, 165, 50, 30, 228, 138, 65, 16, 137, 12, 224,
                106, 6, 211, 82, 219, 226, 84, 163, 98, 233, 63, 86, 212, 222, 211, 22, 35, 38, 8,
                173, 86, 93, 233, 207, 161, 149, 67, 159, 20, 168, 107, 127, 157, 27, 51, 178, 208,
                159, 106, 61, 205, 132, 18, 170, 152, 50, 103, 48, 169, 201, 134, 3, 84, 110, 184,
                195, 152, 133, 111, 140, 30, 185, 46, 209, 99, 238, 84, 93, 130, 225, 76, 112, 218,
                60, 113, 93, 55, 88, 46, 3, 212, 106, 217, 35, 122, 216, 241, 152, 101, 208, 250,
                164, 231, 209, 124, 35, 189, 104, 143, 8, 182, 204, 218, 70, 233, 7, 90, 198, 198,
                42, 36, 42, 140, 33, 67, 165, 127, 157, 79, 166, 253, 69, 200, 166, 118, 10, 134,
                86, 13, 101, 236, 175, 252, 30, 209, 181, 223, 247, 241, 226, 51, 179, 65, 248,
                119, 171, 77, 206, 188, 253, 82, 60, 124, 4, 167, 227, 29, 22, 144, 55, 226, 30,
                157, 174, 127, 133, 145, 109, 24, 64, 192, 146, 71, 74, 181, 252, 7, 69, 104, 227,
                65, 199, 219, 88, 208, 241, 182, 28, 208, 203, 15, 3, 102, 147, 90, 112, 81, 9,
                128, 86, 84, 250, 220, 96, 62, 171, 34, 97, 176, 154, 4, 3, 149, 145, 84, 234, 124,
                76, 0, 250, 170, 225, 95, 126, 11, 160, 9, 199, 130, 194, 77, 226, 176, 21, 15,
                225, 234, 86, 203, 229, 186, 97, 220, 131, 239, 53, 247, 232, 4, 161, 11, 67, 39,
                255, 66, 135, 193, 230, 230, 47, 90, 86, 153, 247, 191, 83, 243, 28, 222, 91, 192,
                140, 75, 30, 240, 132, 43, 157, 66, 16, 115, 74, 89, 10, 172, 12, 91, 55, 149, 177,
                152, 143, 132, 72, 20, 159, 214, 111, 124, 48, 48, 79, 99, 150, 113, 101, 144, 27,
                59, 208, 249, 235, 127, 33, 238, 29, 117, 220, 171, 227, 153, 252, 24, 251, 46, 23,
                48, 101, 115, 29, 165, 222, 66, 107, 123, 189, 89, 93, 45, 240, 233, 89, 251, 252,
                172, 141, 140, 215, 59, 6, 44, 112, 249, 179, 125, 65, 86, 150, 227, 30, 110, 243,
                96, 112, 31, 93, 63, 132, 12, 224, 26, 91, 198, 84, 158, 165, 77, 123, 137, 252,
                117, 133, 254, 216, 199, 110, 121, 49, 8, 246, 246, 213, 164, 222, 3, 48, 136, 174,
                102, 147, 189, 253, 58, 148, 182, 207, 188, 221, 59, 207, 188, 221, 142, 119, 224,
                211, 61, 62, 110, 222, 10, 49, 78, 88, 115, 152, 134, 78, 227, 23, 158, 240, 192,
                30, 201, 5, 0, 0
            ]
            .to_vec(),
        ...
        static ref TRAFFIC_FOUR: Traffic = Traffic {
            ...
            path: "/f81d4fae-7dec-11d0-a765-00a0c91e6bf6/f83f4fae-7dec-11d4-a768-03a0d91e6bf6"
                .to_string(),
            query: "xjs=s2".to_string(),
            request_headers: HashMap::from([
                ("cookie".to_string(), "foo=bar".to_string()),
        ...
        static ref TRAFFIC_FIVE: Traffic = Traffic {
            method: "GET".to_string(),
            scheme: "https".to_string(),
            host: "sso.foobar.com".to_string(),
            path: "/oauth/token".to_string(),
            query: "?code=foobar".to_string(),
            request_headers: HashMap::from([
                ("cookie".to_string(), "foo=bar".to_string()),
                ("sec-fetch-site".to_string(), "same-origin".to_string()),
                ("host".to_string(), "sso.foobar.com".to_string()),
            ]),
            request_body: [].to_vec(),
            request_body_string: None,
            status: 200,
    ...
    /* NEED TO SORT OUT ONCECELL CONFIG ISSUES. */
    //#[tokio::test]
    //async fn test_allow_list() {

    //    let traffic_five = TRAFFIC_FIVE.clone(); // sso.foobar.com
    //    let traffic_three = TRAFFIC_THREE.clone(); // evil.com

    //    assert_eq!(Ok(()),check_allow_list_host(&mut traffic_five.clone()).await);
    //    assert_ne!(Err(()),check_allow_list_host(&mut traffic_five.clone()).await);

    //    assert_eq!(Err(()),check_allow_list_host(&mut traffic_three.clone()).await);
    //    assert_eq!(Ok(()),check_allow_list_host(&mut traffic_three.clone()).await);
    //}
    ...
    //    assert_eq!(Ok(()),check_deny_list_host(&mut traffic_five.clone()).await);
    //    assert_ne!(Err(()),check_deny_list_host(&mut traffic_five.clone()).await);

    //    assert_eq!(Err(()),check_deny_list_host(&mut traffic_three.clone()).await);
    //    assert_ne!(Ok(()),check_deny_list_host(&mut traffic_three.clone()).await);
    //}

    //#[tokio::test]
    //async fn test_identity_providers() {

    //    let mut traffic_five = TRAFFIC_FIVE.clone(); // sso.foobar.com
    //    let mut traffic_four = TRAFFIC_FOUR.clone(); // www.foobar.com

    //    assert_eq!(Err(()),check_identity_providers(&mut traffic_five).await);
    //    assert_ne!(Ok(()),check_identity_providers(&mut traffic_five).await);

    //    assert_eq!(Ok(()),check_identity_providers(&mut traffic_four).await);
    //    assert_ne!(Err(()),check_identity_providers(&mut traffic_four).await);
    //}
